...
export const rawMaterials: RawMaterial[] = [
  ...
  { id: 'm007', name: '冰糖', category: '雜糧類', spec: '50斤/袋(10包)', unit: '袋' },
  { id: 'm008', name: '三花樹薯粉(太白粉)', category: '雜糧類', spec: '50斤/袋', unit: '袋' },
  { id: 'm009', name: '光中杏仁粉(杏仁茶)', category: '雜糧類', spec: '1箱8包', unit: '包' },
  ...
  { id: 'm020', name: '狀元仙草', category: '罐裝/袋裝類', spec: '1箱6瓶', unit: '箱', notes: '叫貨最少7箱' },
  ...
  { id: 'm026', name: '甘蔗原汁', category: '其他供應商', spec: '6瓶/箱', unit: '箱' },
  { id: 'm027', name: '花生醬', category: '其他供應商', spec: '', unit: '包' },
  { id: 'm028', name: '鮮奶', category: '其他供應商', spec: '1箱20瓶', unit: '箱' },
  { id: 'm029', name: '冰淇淋液', category: '其他供應商', spec: '1箱12瓶', unit: '瓶' },
]
