...
這個專案是目前最最最重要的專案，每天有大量資料輸入，修改請務必小心，每修改一個項目就驗證，不求快 求安全完美

## 🔴 新對話啟動強制指令
每次新對話開始，必須立即讀取以下記憶檔案恢復完整上下文，禁止在未讀取前回答任何問題：
```
C:\Users\YEN\.claude\projects\C--Users-YEN-YEN-project-Yba-order\memory\REOPEN_GUIDE.md
```
讀完後才能開始工作。
## 🛡️ 核心原則：誠實、精準、可驗證
